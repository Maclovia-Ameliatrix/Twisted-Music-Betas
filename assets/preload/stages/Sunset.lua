function onCreate()
	makeLuaSprite('bg','amorverse/sunset/BG1',-970, -475)
	setScrollFactor('bg',0.3, 0.3)
	scaleObject('bg', 0.8, 0.8)
	addLuaSprite('bg')

	makeLuaSprite('bg1','amorverse/sunset/BG2',-630, -330)
	setScrollFactor('bg1',0.5, 0.5)
	scaleObject('bg1', 0.6, 0.6)
	addLuaSprite('bg1')

	makeAnimatedLuaSprite('Public', 'amorverse/sunset/ex_crowd_sunset', -400, -200)
	...
	makeLuaSprite('bg2','amorverse/sunset/BG3',-800, -500)
