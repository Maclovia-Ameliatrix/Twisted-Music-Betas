...
function onCreate()--you can't do anything to the characters until the pre-create post
	...
	makeLuaSprite('room2', 'Minor Mods/bedroom/bedroom_backdrop', -567, -152);
	setLuaSpriteScrollFactor('room2', 1.0, 1.0);
	setObjectOrder('room2', 0);

	makeLuaSprite('bed2', 'Minor Mods/bedroom/bed', 27, 570);
	setLuaSpriteScrollFactor('bed2', 1.0, 1.0);
	setObjectOrder('bed2', 2);


   	makeAnimatedLuaSprite('table2','Minor Mods/bedroom/bedside_table', 1120, 460)
    addAnimationByPrefix('table2','Minor Mods/bedroom/bedside_table','bedside table',24,true);
    objectPlayAnimation('table2','bedside table',false);
	setLuaSpriteScrollFactor('table2', 1.2, 1.1);
	setObjectOrder('table2', 5);

	makeLuaSprite('lamp2', 'Minor Mods/bedroom/lamp', -106, -142);
	setLuaSpriteScrollFactor('lamp2', 1.1, 1.2);
    setObjectOrder('lamp2', 3);

   	makeAnimatedLuaSprite('stars2','Minor Mods/bedroom/the_cool_star_thing', 950, 250)
	...
	-- background shit
	makeLuaSprite('room', 'Minor Mods/bedroom/bedroom_backdrop_dark', -567, -152);
	setLuaSpriteScrollFactor('room', 1.0, 1.0);
	setObjectOrder('stars', 6);	

	makeLuaSprite('bed', 'Minor Mods/bedroom/bed_dark', 27, 570);
	setLuaSpriteScrollFactor('bed', 1.0, 1.0);
	setObjectOrder('bed', 6);

   	makeAnimatedLuaSprite('table','Minor Mods/bedroom/bedside_table_dark', 1120, 460)
    	addAnimationByPrefix('table','Minor Mods/bedroom/bedside_table_dark','bedside table dark',24,true);
    	objectPlayAnimation('table','bedside table',false);
	setLuaSpriteScrollFactor('table', 1.2, 1.1);
 	setObjectOrder('table', 10);

	makeLuaSprite('lamp', 'Minor Mods/bedroom/lamp_dark', -106, -142);
	setLuaSpriteScrollFactor('lamp', 1.1, 1.2);
        setObjectOrder('lamp', 9);

	makeLuaSprite('stars', 'Minor Mods/bedroom/stars_dark', 1052, 250);
