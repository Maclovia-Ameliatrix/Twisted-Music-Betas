...
function onCreate()
	...
	-- background shit
	makeLuaSprite('room', 'Minor Mods/bedroom/bedroom_backdrop', -567, -152);
	setLuaSpriteScrollFactor('room', 1.0, 1.0);	

	makeLuaSprite('bed', 'Minor Mods/bedroom/bed', 27, 570);
	setLuaSpriteScrollFactor('bed', 1.0, 1.0);

   	makeAnimatedLuaSprite('table','Minor Mods/bedroom/bedside_table', 1120, 460)
    	addAnimationByPrefix('table','minor mods/bedroom/bedside_table','bedside table',24,true);
    	objectPlayAnimation('table','bedside table',false);
	setLuaSpriteScrollFactor('table', 1.2, 1.1);

	makeLuaSprite('lamp', 'Minor Mods/bedroom/lamp', -106, -162);
	setLuaSpriteScrollFactor('lamp', 1.1, 1.2);
        setObjectOrder('lamp', 2);

   	makeAnimatedLuaSprite('stars','Minor Mods/bedroom/the_cool_star_thing', 950, 250)
