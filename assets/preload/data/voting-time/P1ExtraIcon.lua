function onCreate()
	...
	loadGraphic('icon3', 'icons/Red Mungus', 150)
	addAnimation('icon3', 'icons/Red Mungus', {0, 1}, 0, true)
	...
	loadGraphic('icon4', 'icons/White Jelqer', 150)
	addAnimation('icon4', 'icons/White Jelqer', {0, 1}, 0, true)
	addLuaSprite('icon4', true)
  	setProperty('icon4.flipX', false)
	setObjectOrder('icon4', getObjectOrder('iconP2') + 2)
