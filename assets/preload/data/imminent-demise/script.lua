...
function onCreate()
    ...
    setProperty('AltBG3.visible', true)
...
function onUpdate()
    ...
    if curStep == 1129 then
        ...
        setProperty('AltBG.visible', false)	
        setProperty('AltBG2.visible', false)	
        setProperty('AltBG3.visible', false)	
        setProperty('AltBG4.visible', false)	
        setProperty('AltBG5.visible', false)	
    end
end